...
const Skills =()=>{
    return(
        ...
        <div className="bg-cover  bg-center min-h-screen items-center bg-gradient-to-tr from-indigo-400 from-10% via-sky-500 via-30% to-emerald-400 to-90%">
